...
5. At each iteration, use the `message()` function to print the p-value for the Episode covariate and the Adjusted R-squared for each model.
...
7. We can add this to the graph as text using the `text()` function. This requires x and y coordinates for the text. For instance,
