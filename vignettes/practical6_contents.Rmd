...
```{r, echo=TRUE, fig.keep='all', fig.margin=TRUE, tidy = FALSE}
library("ggplot2")
library("tibble")
...
```{r, fig.cap="Distribution of resting places in a game of monopoly using `no_of_turns` rolls.", echo = FALSE, out.width="60%", out.height="60%"}
